                    ...
                    <tbody>
                        <tr class="lead-row">
                            <td class="expand-cell">
                                <button class="expand-btn" onclick="toggleRow(this)">
                            ...
                            <td colspan="10">
                                <div class="details-content">
                                    <div class="details-grid">
                                        ...
                                        <div class="detail-item">
                                            <strong>Source:</strong> Event
                                        </div>
                                        <div class="detail-item">
                                            <strong>Last Contact:</strong> Yesterday 11:20 AM
                                        </div>
                                        <div class="detail-item">
                                            <strong>Notes:</strong> Interested in 2BHK apartment. Budget around 50L.
                                        </div>
                                        <div class="detail-item">
                                            <strong>Next Follow-up:</strong> 2024-10-20 10:00:00
                                        </div>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr class="lead-details">
                            <td colspan="10">
                                <div class="details-content">
                                    <div class="details-grid">
                                        <div class="detail-item">
                                            <strong>Phone:</strong> (555) 789-0123
                                        </div>
                                        <div class="detail-item">
                                            <strong>Email:</strong> ayush@example.com
                                        </div>
                                        <div class="detail-item">
                                            <strong>Source:</strong> Website
                                        </div>
                                        <div class="detail-item">
                                            <strong>Last Contact:</strong> 2 days ago 2:15 PM
                                        </div>
                                        <div class="detail-item">
                                            <strong>Notes:</strong> Looking for 3BHK villa. Prefers gated community.
                                        </div>
                                        <div class="detail-item">
                                            <strong>Next Follow-up:</strong> 2024-10-19 14:00:00
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td colspan="10">
                                <div class="details-content">
                                    <div class="details-grid">
                                        ...
                                        <div class="detail-item">
                                            <strong>Email:</strong> abhay@example.com
                                        </div>
                                        <div class="detail-item">
                                            <strong>Source:</strong> Website
                                        </div>
                                        <div class="detail-item">
                                            <strong>Last Contact:</strong> 3 days ago 4:30 PM
                                        </div>
                                        <div class="detail-item">
                                            <strong>Notes:</strong> Interested in 1BHK apartment. Budget around 30L.
                                        </div>
                                        <div class="detail-item">
                                            <strong>Next Follow-up:</strong> 2024-10-21 09:00:00
                                        </div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td colspan="10">
                                <div class="details-content">
                                    <div class="details-grid">
                                        ...
                                        <div class="detail-item">
                                            <strong>Email:</strong> lisa.a@example.com
                                        </div>
                                        <div class="detail-item">
                                            <strong>Source:</strong> Referral
                                        </div>
                                        <div class="detail-item">
                                            <strong>Last Contact:</strong> 1 hour ago 2:30 PM
                                        </div>
                                        <div class="detail-item">
                                            <strong>Notes:</strong> Referred by existing customer. Looking for investment property.
                                        </div>
                                        <div class="detail-item">
                                            <strong>Next Follow-up:</strong> 2024-10-18 10:00:00
                                        </div>
                                    </div>
                                </div>
                            </td>
...
function toggleRow(button) {
  ...
  if (detailsRow.classList.contains('lead-details')) {
...
$(document).ready(function() {
    ...
    $('#leadsTable').DataTable({
        ...
        order: [[7, 'desc']], // Sort by last contact date
        responsive: true,
        ...
        columnDefs: [
            { targets: [9, 8], orderable: false }, // Actions and Update Status columns not sortable
            { targets: [0, 1, 2, 3, 4, 5, 6, 7], orderable: false }, // Disable default sorting for all filterable columns
